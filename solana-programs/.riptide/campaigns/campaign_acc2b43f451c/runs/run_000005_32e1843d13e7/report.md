...
- **Seed**: 1209978508
- **Ticks**: 10
- **Agents**: 4 (2× High-volume dispensary, 2× Low-volume dispensary)
- **Scenario**: happy-split
- **Output**: `/root/dpo2u-solana/solana-programs/.riptide/campaigns/campaign_acc2b43f451c/runs/run_000005_32e1843d13e7`
...
**Agent lifecycle**: 4 active, 0 liquidated, 0 depleted

## Invariants

| Invariant | Firings | First tick |
|-----------|---------|------------|
| kbr_bps_canonical | 11 | T0 |
| buyback_bps_canonical | 11 | T0 |
| staking_bps_canonical | 11 | T0 |
| fundo_bps_canonical | 11 | T0 |
...
- T1: High-volume dispensary (agent-001) — distribute_fee → failed
- T1: High-volume dispensary (agent-002) — distribute_fee → failed
- T1: Low-volume dispensary (agent-003) — distribute_fee → failed
- T1: Low-volume dispensary (agent-004) — distribute_fee → failed
